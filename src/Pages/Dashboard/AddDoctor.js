...
const AddDoctor = () => {
    ...
    const { data: services, isLoading } = useQuery('services', () => fetch('https://easy-doctors-portals.onrender.com/service').then(res => res.json()))
    ...
    const onSubmit = async data => {
        ...
        .then(result =>{
            if(result.success){
                ...
                fetch('https://easy-doctors-portals.onrender.com/doctor',{
                    method:"POST",
                    headers:{
